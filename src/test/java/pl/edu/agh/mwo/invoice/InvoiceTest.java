...
public class InvoiceTest {
    ...
    public void testTwoInvoicesHaveConsequentNumbers() {
        int number = invoice.getNumber();
        int number2 = new Invoice().getNumber();
        Assert.assertEquals(number2, number + 1);
    }

    @Test
    public void testEmptyInvoiceHasNoProducts() {
        String[] productList = invoice.getProductList().split("\n");
        Assert.assertEquals(productList[1], "Liczba pozycji: 0");
    }

    @Test
    public void testProductListStartsWithInvoiceNumber() {
        String[] productList = invoice.getProductList().split("\n");
        Assert.assertEquals(productList[0], "" + invoice.getNumber());
    }
    ...
    @Test
    public void testInvoiceHasOneItemForEachProduct() {
        // 2x chleb - price with tax: 10
        invoice.addProduct(new TaxFreeProduct("Chleb", new BigDecimal("5")), 2);
